...
import com.hkprogrammer.cursomc.domain.Endereco;
...
import com.hkprogrammer.cursomc.domain.PagamentoComCartao;
...
import com.hkprogrammer.cursomc.domain.enums.Perfil;
import com.hkprogrammer.cursomc.domain.enums.TipoCliente;
import com.hkprogrammer.cursomc.repositories.CategoriaRepository;
import com.hkprogrammer.cursomc.repositories.CidadeRepository;
import com.hkprogrammer.cursomc.repositories.ClienteRepository;
import com.hkprogrammer.cursomc.repositories.EnderecoRepository;
import com.hkprogrammer.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "henrytomasdeluz@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
			
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@email.com", "12345621312",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("91963323", "9193838393"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "66615026", cli2, c2);
